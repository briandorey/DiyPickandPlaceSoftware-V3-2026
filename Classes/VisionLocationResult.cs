...
namespace PickandPlace2026.Classes
{
    public class VisionLocationResult
    {
        ...
        public VisionLocationResult(double loc1x, double loc1y, double loc2x, double loc2y, double loc3x, double loc3y, double loc4x, double loc4y, double itemwidth, double itemheight, double locangle, string loctext, double offsetx, double offsety, System.Drawing.Bitmap? image)
        {
            Loc1X = loc1x;
            Loc1Y = loc1y;
            Loc2X = loc2x;
